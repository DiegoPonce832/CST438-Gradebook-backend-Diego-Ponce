...
public class JunitTestGradebook {
	...
	public void addAssignment() throws Exception {
		...
		// then do an http get request for assignment 1
		response = mvc.perform(MockMvcRequestBuilders.post("/add?id=10&name=test&dueDate=2022-10-12").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
	...
	public void deleteAssignment() throws Exception {
		...
		// then do an http get request for assignment 1
		response = mvc.perform(MockMvcRequestBuilders.post("/delete/7").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
	...
	public void updateAssignmentName() throws Exception {
		...
		// then do an http get request for assignment 1
		response = mvc.perform(MockMvcRequestBuilders.put("update?id=9&name=Newtest").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
